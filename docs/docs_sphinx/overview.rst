...
The Crank-Nicolson time-stepper evaluates a residual:

::

    F = i M psi_dot -- H psi -- E(t)*D psi

where psi_dot is the time derivative, M is the mass matrix, H is the Hamiltonian,
and E(t)*D is the laser coupling.
